...
function bs_bp_activity_screen_notification_settings() {
	...
	<h4><?php _e( 'Activity', 'buddypress' ) ?></h4>

	<?php printf( __( 'A member mentions you in an update using "@%s"', 'buddypress' ), bp_core_get_username( bp_displayed_user_id() ) ) ?>
    ...
    <p class="padding"><?php _e( "A member replies to an update or comment you've posted", 'buddypress' ) ?></p>
...
function bs_friends_screen_notification_settings() {
	...
	<div class="padding">
		...
		<h4><?php _e( 'Friends', 'buddypress' ) ?></h4>

		<?php _e( 'A member sends you a friendship request', 'buddypress' ) ?>
	...
	<p class="padding"><?php _e( 'A member accepts your friendship request', 'buddypress' ) ?></p>
...
function bs_messages_screen_notification_settings() {
	...
	<div class="padding">
		...
		<h4><?php _e( 'Messages', 'buddypress' ) ?></h4>

		<?php _e( 'A member sends you a new message', 'buddypress' ) ?>
	...
	<p class="padding"><?php _e( 'A new site notice is posted', 'buddypress' ) ?></p>
...
?>
	...
	<div class="padding">
		<h4><?php _e( 'Groups', 'buddypress' ) ?></h4>

		<?php _e( 'A member invites you to join a group', 'buddypress' ) ?>
	</div>
	...
	<p class="padding"><?php _e( 'Group information is updated', 'buddypress' ) ?></p>
	...
	<p class="padding"><?php _e( 'You are promoted to a group administrator or moderator', 'buddypress' ) ?></p>
	...
	<p class="padding"><?php _e( 'A member requests to join a private group for which you are an admin', 'buddypress' ) ?></p>
