			...
			<?php if ( is_user_logged_in() ) : ?>
				...
				<form action="<?php bp_activity_comment_form_action(); ?>" method="post" id="ac-form-<?php bp_activity_id(); ?>" class="ac-form list"<?php bp_activity_comment_form_nojs_display(); ?>>
					...
					<div class="ac-reply-content">
						...
						<div>
							<input type="submit" class="button button-primary" name="ac_form_submit" value="<?php esc_attr_e( 'Post', 'appp_ion' ); ?>" /> 
							<a href="#" class="button button-secondary ac-reply-cancel"><?php _e( 'Cancel', 'appp_ion' ); ?></a>
						</div>
