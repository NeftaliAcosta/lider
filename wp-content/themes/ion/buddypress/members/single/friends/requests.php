	...
	<ul id="friend-list" class="item-list list" role="main">
		<?php while ( bp_members() ) : bp_the_member(); ?>
			...
			<li id="friendship-<?php bp_friend_friendship_id(); ?>" class="item">
				...
				<div class="action">
					<a class="button button-primary accept" href="<?php bp_friend_accept_request_link(); ?>"><?php _e( 'Accept', 'appp_ion' ); ?></a> &nbsp;
					<a class="button button-secondary reject" href="<?php bp_friend_reject_request_link(); ?>"><?php _e( 'Reject', 'appp_ion' ); ?></a>
...
<?php else: ?>
	...
	<div id="message" class="info">
		<p><?php _e( 'You have no pending friendship requests.', 'appp_ion' ); ?></p>
	</div>
