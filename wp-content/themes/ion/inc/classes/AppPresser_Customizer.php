...
class AppPresser_Customizer {
	...
	public function register( $wp_customize ) {
		...
		$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'appp_logo', array(
			'label'    => __( 'Upload Logo (replaces text)', 'appp_ion' ),
			'section'  => 'title_tagline',
			'settings' => 'appp_logo',
		) ) );

		$wp_customize->add_section( 'static_mobile_front_page', array(
			'title' => __('Mobile Front Page', 'appp_ion'),
			'priority' => 10,
			'description' => '',
		...
		if( class_exists('AppPresser_Swipers')  ) {
			...
			$wp_customize->add_control( 'homepage_slider_control', array(
				'type'     => 'checkbox',
				'label'    => __( 'Add slider to homepage?', 'appp_ion' ),
				'section'  => 'static_mobile_front_page',
				'priority' => 124,
			...
			$wp_customize->add_control( 'homepage_slider_category_control', array(
				'type'     => 'select',
				'label'    => __( 'What category?', 'appp_ion' ),
				'section'  => 'static_mobile_front_page',
				'priority' => 125,
				'choices'  => $_cats,
				'settings' => 'slider_category_control',
				'description' => __('Uses slides custom post type by default. To show all posts, select a category below.', 'appp_ion'),
			) );
	...
	public function colors() {
		...
		$colors = array(
			'body_bg' => array(
				'default' => '#ffffff',
				'label'   => __( 'Body Background', 'appp_ion' ),
			...
			'text_color' => array(
				'default' => '#333333',
				'label'   => __( 'Text Color', 'appp_ion' ),
				'sprintf' => 'body, p, .item p, .item, .input-label, .entry-meta, .list-group a, .list-group a:visited, .activity-list .activity-header p, .activity-list .activity-header a, .activity-list .acomment-meta, .activity-list .acomment-meta a, .activity-list .acomment-options a { color: **color**; }',
			),
			'link_color' => array(
				'default' => '',
				'label' => __( 'Link Color', 'appp_ion' ),
			...
			'top_bar_bg_color' => array(
				'default' => '#1495cf',
				'label' => __( 'Header/Footer Bg Color', 'appp_ion' ),
				'sprintf' => '.bar-header, .bar-footer, .footer-menu, .tabs { background-color: **color**; }',
			),
			'top_bar_text_color' => array(
				'default' => '#ffffff',
				'label' => __( 'Header/Footer Text Color', 'appp_ion' ),
				'sprintf' => '.bar-header, .bar-footer, .footer-menu, .bar-header a, .footer-menu .tab-item, .footer-menu .tab-item a, .bar-header i, .footer-menu .tab-item i, .bar-header .button { color: **color** !important; }',
			),
			'left_menu_bg' => array(
				'default' => '#fafafa',
				'label' => __( 'Left Menu Background', 'appp_ion' ),
			...
			'left_panel_text' => array(
				'default' => '#333333',
				'label' => __( 'Left Menu Text', 'appp_ion' ),
