...
class AppPresser_Extension_Compatibility {
	...
	?>
		<aside class="io-modal" id="geo-checkin-form" tabindex="-1" role="dialog" aria-hidden="true">
			...
			<?php if ( is_user_logged_in() ) : ?>
				...
				<a href="#" class="button button-primary button-block noajax btn-checkin" onclick="AppGeo_checkin( <?php echo $user_ID; ?> );"><?php _e('Check In', 'appgeo') ; ?></a>
	...
	public function appbuddy_new_button() {
		...
		if ( is_user_logged_in() ) {
			...
			return '<a class="button button-icon ion-ios-compose-outline io-modal-open" href="#activity-post-form"></a>';

		} else {

			return '<a class="button button-icon ion-ios-person io-modal-open" href="#loginModal"></a>';
